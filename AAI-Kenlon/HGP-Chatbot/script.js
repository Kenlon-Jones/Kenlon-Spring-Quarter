...
const rules = [
  ...
  { match: ["paris"], reply: "Paris, you mean that 5'7 grown ahh man taking calls all day for his due rent?" },
  { match: ["information"], reply: "For more information about the HGP, you can visit https://www.hiddengeniusproject.org for any questions you have." },
  { match: ["push ups"], reply: "The only reason to do push ups is if you do not follow Ubuntu (I am because we are)." }
];
